...
public class TestBookingDB
{
    ...
    public void setUp()
    {
        ...
        bookingDB = new BookingDB(room[0], checkIn, checkOut, 
    ...
    public void tearDown()
    {
        ...
        try 
        {
            ...
            stmt = conn.createStatement();
            s = "DELETE FROM ROOMS WHERE RoomID = " + room[0].getRoomID();
            stmt.executeUpdate(s);
            stmt = null;
            ...
            stmt = conn.createStatement();
            s = "DELETE FROM OCCUPANCY WHERE oRoomID = " + room[0].getRoomID() +
